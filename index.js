...
// Each answer is dependent on the size of the string
...
function nonCacheMemA(num1, num2, num3) {
  let answer = num1 + num2 + num3
  return answer
}
...
const myMemA = new MemA

console.time("not memoized function time");
console.log(nonCacheMemA(7,8,9))
console.log(nonCacheMemA(7,8,9))
console.log(nonCacheMemA(7,8,9))
console.log(nonCacheMemA(7,8,9))
...
console.log(myMemA.cacheA(7,8,9))
console.log(myMemA.cacheA(7,8,9))
console.log(myMemA.cacheA(7,8,9))
console.log(myMemA.cacheA(7,8,9))
